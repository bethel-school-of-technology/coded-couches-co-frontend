    ...
    return (
        ...
        <h1>Users Management</h1>
            ...
            <table border="1" >
                ...
                { users.map(user => 
                    <tr key={user.id}>
                        <td className="tdSmall">{user.id}</td>
                        <td className="tdLarge">{user.username}</td>
                        <td className="tdLarge">{(user.admin === true)? 'is admin': 'is not admin'}</td>
                        <td className="tdLarge">{moment(user.createdAt).format("MMMM Do YYYY")}</td>
